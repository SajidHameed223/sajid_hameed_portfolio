...
const experienceData: ExperienceItem[] = [
  ...
  },
  {
    ...
    company: "Code Celix",
    description: "Build Gen AI Projects and natural language processing tasks.",
  },
  {
    id: "3",
    year: "2023",
        ...
        <AnimatePresence mode="wait">
          {activeTab === "education" && (
            ...
            >
              ...
              <p className="text-muted mb-8 w-auto">
                I am a Software Developer with a BS in Software Engineering. I
                blend technical skills with a passion for learning and strategic
                insights. Below are my education details:
              </p>
          ...
          {activeTab === "experience" && (
            ...
            >
              ...
              <p className="text-muted mb-8 w-auto">
                Over 1+ year of professional experience in software development,
                working with startups and established companies to deliver
          ...
          {activeTab === "skills" && (
            ...
            >
              ...
              <p className="text-muted mb-8 w-auto">
                ...
                databases, Machine Learning and Gen AI. Continuously learning
