...
const educationData: EducationItem[] = [
  ...
  },
  {
    id: "4",
    year: "2024-2026",
    title: "Master of Business Administration (MBA) in Business Analytics",
...
const profileData = {
  name: "Sajid Hameed",
  role: "Software Engineer & MBA Student",
  location: "India",
  email: "sajid@example.com",
  phone: "+91 8910171611",
  bio: "I am a passionate Software Developer with hands-on experience in real-time projects, focused on building scalable and efficient solutions. Currently pursuing an MBA in Business Analytics to bridge the gap between technology and business.",
};
...
const EducationCard = ({
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 rounded-2xl bg-gradient-to-br from-[#23232a] to-[#1a1a20] border border-orange-500/10 hover:border-orange-500/30 hover:shadow-[0_10px_40px_rgba(249,115,22,0.25)] transition-all duration-300"
    >
      ...
      <h3 className="text-lg font-bold text-gray-100 mb-2 group-hover:text-orange-400 transition-colors">
        {item.title}
      </h3>
...
const ExperienceCard = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-bold text-gray-100 mb-1 group-hover:text-orange-400 transition-colors">
        {item.role}
      </h3>
...
const SkillCard = ({ skill, index }: { skill: SkillItem; index: number }) => {
  return (
    <motion.div
      ...
      className="group relative h-24 rounded-xl bg-[#1a1a20] border border-zinc-800 hover:border-orange-500/50 transition-all duration-300 flex items-center justify-center cursor-pointer hover:shadow-[0_10px_40px_rgba(249,115,22,0.25)]"
    >
      <Image
        src={skill.icon}
        alt={skill.name}
      ...
      <span className="absolute -top-8 py-1.5 px-4 text-xs font-bold text-white rounded-md bg-zinc-900 border border-orange-400/20 opacity-0 group-hover:opacity-100 transition-all duration-300">
        {skill.name}
      </span>
    </motion.div>
  );
...
const ProfileCard = () => {
  return (
    <motion.div
      ...
      className="p-8 rounded-2xl bg-gradient-to-br from-[#23232a] to-[#1a1a20] border border-orange-500/20 hover:shadow-[0_10px_40px_rgba(249,115,22,0.25)] transition-all duration-300"
    >
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 pt-6 border-t border-orange-500/10 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
            ...
            <div>
              ...
              <p className="text-gray-200 text-sm">{profileData.phone}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#1C1C22] text-gray-400 font-sans selection:bg-orange-500/30 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="flex w-fit mx-auto flex-wrap justify-center gap-2 p-2 rounded-2xl bg-[#23232a]/60 backdrop-blur-md border border-orange-500/10 shadow-lg shadow-black/20 mb-12"
        >
          {tabs.map((tab) => (
            <TabButton
              key={tab.id}
          ...
          {activeTab === "education" && (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-200">Education</h3>
              </div>
          ...
          {activeTab === "skills" && (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-200">Skills</h3>
              </div>
          ...
          {activeTab === "profile" && (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-200">Profile</h3>
              </div>
