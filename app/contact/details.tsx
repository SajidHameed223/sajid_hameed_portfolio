    ...
    <div className="mb-8">
      ...
      <div className="relative w-full overflow-hidden h-8 mb-6">
        <div className="flex w-max animate-form-marquee whitespace-nowrap text-muted text-lg">
          Hi, I'm Sajid Hameed! Fill out the form below to collaborate on web
          development, UI/UX design, or consultancy. Let's create something
          amazing together!
        </div>
      </div>
    </div>
